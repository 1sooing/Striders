...
public class BluetoothConnection {
    ...
    public BluetoothConnection(Context context, Handler handler){
        ...
        mState = STATE_NONE;
        mHandler = handler;
        Log.d(TAG, "-------------------UUID" + UUID.fromString(getUUID(context)));
       // MY_UUID= UUID.fromString(getUUID(context));
    }
    public static String getUUID(Context context) {
        ...
        UUID deviceUUID = new UUID( phID.hashCode(),
                (devID.hashCode() << 32) | serial.hashCode() );
